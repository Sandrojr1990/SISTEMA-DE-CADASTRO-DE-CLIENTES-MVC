...
export class ClienteController {
    ...
    transferirValor(emailOrigem: string, emailDestino: string, valor: number): void {
        const clienteOrigem = this.clientes.find(cliente => cliente.email === emailOrigem);
        const clienteDestino = this.clientes.find(cliente => cliente.email === emailDestino);
